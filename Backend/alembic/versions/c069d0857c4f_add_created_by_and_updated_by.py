...
def downgrade() -> None:
    ...
    op.drop_constraint(None, 'profit_loss', type_='foreignkey')
    op.drop_constraint(None, 'profit_loss', type_='foreignkey')
    ...
    op.drop_constraint(None, 'employee_details', type_='foreignkey')
    op.drop_constraint(None, 'employee_details', type_='foreignkey')
    ...
    op.drop_constraint(None, 'customer_invoices', type_='foreignkey')
    op.drop_constraint(None, 'customer_invoices', type_='foreignkey')
